...
MultipartRequest multi = new MultipartRequest(request, request.getRealPath(savePath), EDITOR_MAXSIZE, "utf-8",  new DefaultFileRenamePolicy()); //DefaultFileRenamePolicy 서버랑 이름이 같으면 숫자를 붙임
