...
<body>    
  <div class="sub">
      <div class="size">
          ...
          <div class="bbs">
          <form method="post" name="frm" id="frm" action="insert.do" enctype="multipart/form-data"> <!-- enctype= 파일업로드-->
              <!--<inpit type="hidden" name="member_no" vlaue="${loginInfo.no}">-->
              <table class="board_write">
                  ...
                  <tr>
                      <th>내용</th>
                      <td>
                          <textarea name="content" id="contents" style="width:90%;"></textarea>
                      </td>
                  </tr>
                  <tr>
                  	<th>첨부파일</th>
